...
def plot_image_grid(images_array, image_shape, n_pictures, cmap=cmocean.cm.balance, save=True, row_titles=None, name='grid'+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")+'.pdf'):
    """
